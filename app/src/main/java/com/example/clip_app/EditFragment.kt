...
class EditFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        key= arguments?.getString("LAKEY").toString()
        consultarDatosID(key)
    ...
    private fun desplegarAlertDialog(){
    ...
    private fun editarDataBase(id: String){
        //conecta con la base de datos
        var db= DataBase(requireContext())
        //comprueba que no aiga ningun campo vacio
        var recorda= Recordatorio(id.toInt(),et_editNombre.text.toString(),et_editFecha.text.toString(),et_editHora.text.toString(),et_editFecha.text.toString()+" "+et_editHora.text.toString(),et_editCategoria.text.toString(),et_editDescripcion.text.toString())
    ...
    private fun VaciarCampos(){
        ...
        et_editCategoria.setText("")
        et_editFecha.setText("")
        et_editHora.setText("")
        et_editDescripcion.setText("")
    }
    ...
    private fun consultarDatosID(id:String){
        var db= DataBase(requireContext())
