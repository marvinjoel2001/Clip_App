   ...
   private fun CargarItem(){
        ...
        if (data != null) {
            for (i in 0 until data.size) {
                when (data.get(i).categoria){
                    "Recordatorio"->{var item=ItemRd(data.get(i).id!!.toInt(),R.mipmap.reloj_foreground,data.get(i).categoria,data.get(i).name,data.get(i).fecha,data.get(i).hora)
                        list+=item}
                    "Examen"->{var item=ItemRd(data.get(i).id!!.toInt(),R.mipmap.examen_foreground,data.get(i).categoria,data.get(i).name,data.get(i).fecha,data.get(i).hora)
                        list+=item}
                    "Tarea"->{var item=ItemRd(data.get(i).id!!.toInt(),R.mipmap.tarea_foreground,data.get(i).categoria,data.get(i).name,data.get(i).fecha,data.get(i).hora)
                        list+=item}
                    "Reunion"->{var item=ItemRd(data.get(i).id!!.toInt(),R.mipmap.reunion_foreground,data.get(i).categoria,data.get(i).name,data.get(i).fecha,data.get(i).hora)
                        list+=item}
                }
            }
    ...
    override fun onSuperiorClick(item: ItemRd, position: Int) {
       ...
       val intent = Intent(activity,EditActivity::class.java)
        intent.putExtra("ID",item.textId)
